...
def beauty():
    ...
    try:
        ...
        # GET ALL CATEGORIES
        #
        # Every category automatically receives its product
        ...
        flash(
            "Unable to load beauty categories.",
            "error",
        )
...
@app.route("/beauty/category/<int:category_id>")
